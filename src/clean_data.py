...
def main():
    ...
    shots = shots[['player', 'minute', 'second', 'team', 'location', 'shot_outcome','shot_statsbomb_xg', 'shot_end_location']]
    passes = passes[['player', 'minute', 'second', 'team', 'location', 'pass_outcome', 'pass_end_location']]
    dribbles = dribbles[['player', 'minute', 'second', 'team', 'location', 'dribble_outcome']]
    #Save cleaned data
